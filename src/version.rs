...
pub fn full() -> &'static str {
    concat!("MerlionOS v40.0.0 (", "x86_64", ")")
}

/// One-line banner.
pub fn banner() -> &'static str {
    "MerlionOS v40.0.0 — Born for AI. Built by AI."
}
